...
public class IssueCustomFieldOptionsApi {
     ...
     */
    public Mono<Object> comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceCreateCustomFieldOptionsPost(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest) throws RestClientException {
        Object postBody = bulkCreateCustomFieldOptionRequest;
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'fieldId' when calling comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceCreateCustomFieldOptionsPost");
        }
        // verify the required parameter 'bulkCreateCustomFieldOptionRequest' is set
        if (bulkCreateCustomFieldOptionRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'bulkCreateCustomFieldOptionRequest' when calling comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceCreateCustomFieldOptionsPost");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<PageBeanCustomFieldOptionDetails> comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceGetOptionsForFieldGet(Long fieldId, Long startAt, Integer maxResults) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'fieldId' when calling comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceGetOptionsForFieldGet");
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<Object> comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceUpdateCustomFieldOptionsPut(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption) throws RestClientException {
        Object postBody = updateCustomFieldOption;
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'fieldId' when calling comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceUpdateCustomFieldOptionsPut");
        }
        // verify the required parameter 'updateCustomFieldOption' is set
        if (updateCustomFieldOption == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'updateCustomFieldOption' when calling comAtlassianJiraRestV2IssueBulkCustomFieldOptionResourceUpdateCustomFieldOptionsPut");
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<CustomFieldOption> comAtlassianJiraRestV2IssueCustomfieldCustomFieldOptionResourceGetCustomFieldOptionGet(String id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling comAtlassianJiraRestV2IssueCustomfieldCustomFieldOptionResourceGetCustomFieldOptionGet");
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
