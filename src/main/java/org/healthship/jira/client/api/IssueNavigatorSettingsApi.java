...
public class IssueNavigatorSettingsApi {
     ...
     */
    public Flux<ColumnItem> comAtlassianJiraRestV2AdminSettingsResourceGetIssueNavigatorDefaultColumnsGet() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<Object> comAtlassianJiraRestV2AdminSettingsResourceSetIssueNavigatorDefaultColumnsPut(List<String> requestBody) throws RestClientException {
