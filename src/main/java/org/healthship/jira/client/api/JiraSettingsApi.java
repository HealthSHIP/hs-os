...
import org.healthship.jira.client.model.ApplicationProperty;
import org.healthship.jira.client.model.ModelConfiguration;
import org.healthship.jira.client.model.SimpleApplicationPropertyBean;
...
public class JiraSettingsApi {
     ...
     */
    public Flux<ApplicationProperty> comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetAdvancedSettingsGet() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Flux<ApplicationProperty> comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetApplicationPropertyGet(String key, String permissionLevel, String keyFilter) throws RestClientException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<ApplicationProperty> comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPut(String id, SimpleApplicationPropertyBean simpleApplicationPropertyBean) throws RestClientException {
        Object postBody = simpleApplicationPropertyBean;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPut");
        }
        // verify the required parameter 'simpleApplicationPropertyBean' is set
        if (simpleApplicationPropertyBean == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'simpleApplicationPropertyBean' when calling comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPut");
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<ModelConfiguration> comAtlassianJiraRestV2AdminConfigurationResourceGetConfigurationGet() throws RestClientException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
