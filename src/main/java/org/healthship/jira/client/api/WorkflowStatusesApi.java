...
public class WorkflowStatusesApi {
     ...
     */
    public Mono<StatusDetails> comAtlassianJiraRestV2IssueStatusResourceGetStatusGet(String idOrName) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'idOrName' is set
        if (idOrName == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'idOrName' when calling comAtlassianJiraRestV2IssueStatusResourceGetStatusGet");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Flux<StatusDetails> comAtlassianJiraRestV2IssueStatusResourceGetStatusesGet() throws RestClientException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
