...
public class JsonNode {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(textValue, fieldNames, valueAsText, elements, number, missingNode, _object, pojo, integralNumber, floatingPointNumber, _int, _long, _double, bigDecimal, bigInteger, textual, _boolean, binary, valueNode, containerNode, numberValue, numberType, intValue, longValue, bigIntegerValue, doubleValue, decimalValue, booleanValue, binaryValue, valueAsInt, valueAsLong, valueAsDouble, valueAsBoolean, array, fields, _null);
  }
