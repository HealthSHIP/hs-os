...
@JsonPropertyOrder({
  PageBeanFoundFilter.JSON_PROPERTY_SELF,
  PageBeanFoundFilter.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFoundFilter.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFoundFilter.JSON_PROPERTY_START_AT,
  PageBeanFoundFilter.JSON_PROPERTY_TOTAL,
  PageBeanFoundFilter.JSON_PROPERTY_IS_LAST,
  PageBeanFoundFilter.JSON_PROPERTY_VALUES
})
...
public class PageBeanFoundFilter {
  ...
  private List<FoundFilter> values = null;
