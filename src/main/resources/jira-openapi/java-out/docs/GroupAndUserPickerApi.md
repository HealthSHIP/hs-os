...
import org.healthship.jira.client.api.GroupAndUserPickerApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            FoundUsersAndGroups result = apiInstance.comAtlassianJiraRestV2IssueGroupAndUserPickerResourceFindUsersAndGroupsGet(query, maxResults, showAvatar, fieldId, projectId, issueTypeId, avatarSize, caseInsensitive, excludeConnectAddons);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupAndUserPickerApi#comAtlassianJiraRestV2IssueGroupAndUserPickerResourceFindUsersAndGroupsGet");
