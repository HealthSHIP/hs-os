...
public class JiraSettingsApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetAdvancedSettingsGetTest()  {
        List<ApplicationProperty> response = api.comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetAdvancedSettingsGet().collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetApplicationPropertyGetTest()  {
        String key = null;
        String permissionLevel = null;
        String keyFilter = null;
        List<ApplicationProperty> response = api.comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetApplicationPropertyGet(key, permissionLevel, keyFilter).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPutTest()  {
        String id = null;
        SimpleApplicationPropertyBean simpleApplicationPropertyBean = null;
        ApplicationProperty response = api.comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPut(id, simpleApplicationPropertyBean).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminConfigurationResourceGetConfigurationGetTest()  {
        ModelConfiguration response = api.comAtlassianJiraRestV2AdminConfigurationResourceGetConfigurationGet().block();
