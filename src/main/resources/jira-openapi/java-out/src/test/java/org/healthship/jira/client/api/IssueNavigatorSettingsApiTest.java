...
public class IssueNavigatorSettingsApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminSettingsResourceGetIssueNavigatorDefaultColumnsGetTest()  {
        List<ColumnItem> response = api.comAtlassianJiraRestV2AdminSettingsResourceGetIssueNavigatorDefaultColumnsGet().collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2AdminSettingsResourceSetIssueNavigatorDefaultColumnsPutTest()  {
        List<String> requestBody = null;
        Object response = api.comAtlassianJiraRestV2AdminSettingsResourceSetIssueNavigatorDefaultColumnsPut(requestBody).block();
