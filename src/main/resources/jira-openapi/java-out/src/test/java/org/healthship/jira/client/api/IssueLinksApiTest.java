...
public class IssueLinksApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueLinkIssueResourceDeleteIssueLinkDeleteTest()  {
        String linkId = null;
        api.comAtlassianJiraRestV2IssueLinkIssueResourceDeleteIssueLinkDelete(linkId).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueLinkIssueResourceGetIssueLinkGetTest()  {
        String linkId = null;
        IssueLink response = api.comAtlassianJiraRestV2IssueLinkIssueResourceGetIssueLinkGet(linkId).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueLinkIssueResourceLinkIssuesPostTest()  {
        LinkIssueRequestJsonBean linkIssueRequestJsonBean = null;
        Object response = api.comAtlassianJiraRestV2IssueLinkIssueResourceLinkIssuesPost(linkIssueRequestJsonBean).block();
