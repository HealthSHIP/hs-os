...
public class TasksApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2TaskTaskResourceCancelTaskPostTest()  {
        String taskId = null;
        Object response = api.comAtlassianJiraRestV2TaskTaskResourceCancelTaskPost(taskId).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2TaskTaskResourceGetTaskGetTest()  {
        String taskId = null;
        TaskProgressBeanObject response = api.comAtlassianJiraRestV2TaskTaskResourceGetTaskGet(taskId).block();
