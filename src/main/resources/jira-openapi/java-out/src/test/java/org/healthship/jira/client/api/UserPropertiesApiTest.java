...
public class UserPropertiesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2UserpropertyUserPropertyResourceDeleteUserPropertyDeleteTest()  {
        String propertyKey = null;
        String accountId = null;
        String userKey = null;
        String username = null;
        api.comAtlassianJiraRestV2UserpropertyUserPropertyResourceDeleteUserPropertyDelete(propertyKey, accountId, userKey, username).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2UserpropertyUserPropertyResourceGetUserPropertyGetTest()  {
        String propertyKey = null;
        String accountId = null;
        String userKey = null;
        String username = null;
        EntityProperty response = api.comAtlassianJiraRestV2UserpropertyUserPropertyResourceGetUserPropertyGet(propertyKey, accountId, userKey, username).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2UserpropertyUserPropertyResourceGetUserPropertyKeysGetTest()  {
        String accountId = null;
        String userKey = null;
        String username = null;
        PropertyKeys response = api.comAtlassianJiraRestV2UserpropertyUserPropertyResourceGetUserPropertyKeysGet(accountId, userKey, username).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2UserpropertyUserPropertyResourceSetUserPropertyPutTest()  {
        String propertyKey = null;
        Object body = null;
        String accountId = null;
        String userKey = null;
        String username = null;
        Object response = api.comAtlassianJiraRestV2UserpropertyUserPropertyResourceSetUserPropertyPut(propertyKey, body, accountId, userKey, username).block();
