...
public class GroupAndUserPickerApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueGroupAndUserPickerResourceFindUsersAndGroupsGetTest()  {
        String query = null;
        ...
        FoundUsersAndGroups response = api.comAtlassianJiraRestV2IssueGroupAndUserPickerResourceFindUsersAndGroupsGet(query, maxResults, showAvatar, fieldId, projectId, issueTypeId, avatarSize, caseInsensitive, excludeConnectAddons).block();
