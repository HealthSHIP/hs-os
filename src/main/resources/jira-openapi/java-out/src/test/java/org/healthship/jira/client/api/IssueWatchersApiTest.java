...
public class IssueWatchersApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceAddWatcherPostTest()  {
        String issueIdOrKey = null;
        String body = null;
        Object response = api.comAtlassianJiraRestV2IssueIssueResourceAddWatcherPost(issueIdOrKey, body).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceGetIssueWatchersGetTest()  {
        String issueIdOrKey = null;
        Watchers response = api.comAtlassianJiraRestV2IssueIssueResourceGetIssueWatchersGet(issueIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceRemoveWatcherDeleteTest()  {
        String issueIdOrKey = null;
        String username = null;
        String accountId = null;
        api.comAtlassianJiraRestV2IssueIssueResourceRemoveWatcherDelete(issueIdOrKey, username, accountId).block();
