...
public class IssueSearchApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceGetIssuePickerResourceGetTest()  {
        String query = null;
        ...
        IssuePickerSuggestions response = api.comAtlassianJiraRestV2IssueIssueResourceGetIssuePickerResourceGet(query, currentJQL, currentIssueKey, currentProjectId, showSubTasks, showSubTaskParent).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2MatchIssueMatchResourceMatchIssuesPostTest()  {
        IssuesAndJQLQueries issuesAndJQLQueries = null;
        IssueMatches response = api.comAtlassianJiraRestV2MatchIssueMatchResourceMatchIssuesPost(issuesAndJQLQueries).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2SearchSearchResourceSearchForIssuesUsingJqlGetTest()  {
        String jql = null;
        ...
        SearchResults response = api.comAtlassianJiraRestV2SearchSearchResourceSearchForIssuesUsingJqlGet(jql, startAt, maxResults, validateQuery, fields, expand, properties, fieldsByKeys).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2SearchSearchResourceSearchForIssuesUsingJqlPostTest()  {
        SearchRequestBean searchRequestBean = null;
        SearchResults response = api.comAtlassianJiraRestV2SearchSearchResourceSearchForIssuesUsingJqlPost(searchRequestBean).block();
