...
public class ProjectPropertiesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectPropertyResourceDeleteProjectPropertyDeleteTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        api.comAtlassianJiraRestV2IssueProjectPropertyResourceDeleteProjectPropertyDelete(projectIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectPropertyResourceGetProjectPropertyGetTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        EntityProperty response = api.comAtlassianJiraRestV2IssueProjectPropertyResourceGetProjectPropertyGet(projectIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectPropertyResourceGetProjectPropertyKeysGetTest()  {
        String projectIdOrKey = null;
        PropertyKeys response = api.comAtlassianJiraRestV2IssueProjectPropertyResourceGetProjectPropertyKeysGet(projectIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectPropertyResourceSetProjectPropertyPutTest()  {
        String projectIdOrKey = null;
        String propertyKey = null;
        Object body = null;
        Object response = api.comAtlassianJiraRestV2IssueProjectPropertyResourceSetProjectPropertyPut(projectIdOrKey, propertyKey, body).block();
