...
public class IssueNotificationSchemesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2NotificationNotificationSchemeResourceGetNotificationSchemeGetTest()  {
        Long id = null;
        String expand = null;
        NotificationScheme response = api.comAtlassianJiraRestV2NotificationNotificationSchemeResourceGetNotificationSchemeGet(id, expand).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2NotificationNotificationSchemeResourceGetNotificationSchemesGetTest()  {
        Long startAt = null;
        Integer maxResults = null;
        String expand = null;
        PageBeanNotificationScheme response = api.comAtlassianJiraRestV2NotificationNotificationSchemeResourceGetNotificationSchemesGet(startAt, maxResults, expand).block();
