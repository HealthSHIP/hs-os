...
public class ProjectRolesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectProjectRoleDetailsResourceGetProjectRoleDetailsGetTest()  {
        String projectIdOrKey = null;
        Boolean currentMember = null;
        Boolean excludeConnectAddons = null;
        List<ProjectRole> response = api.comAtlassianJiraRestV2IssueProjectProjectRoleDetailsResourceGetProjectRoleDetailsGet(projectIdOrKey, currentMember, excludeConnectAddons).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRoleGetTest()  {
        String projectIdOrKey = null;
        Long id = null;
        ProjectRole response = api.comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRoleGet(projectIdOrKey, id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRolesGetTest()  {
        String projectIdOrKey = null;
        Map<String, URI> response = api.comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRolesGet(projectIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourceCreateProjectRolePostTest()  {
        CreateUpdateRoleRequestBean createUpdateRoleRequestBean = null;
        ProjectRole response = api.comAtlassianJiraRestV2IssueProjectRoleResourceCreateProjectRolePost(createUpdateRoleRequestBean).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourceDeleteProjectRoleDeleteTest()  {
        Long id = null;
        Long swap = null;
        api.comAtlassianJiraRestV2IssueProjectRoleResourceDeleteProjectRoleDelete(id, swap).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourceFullyUpdateProjectRolePutTest()  {
        Long id = null;
        CreateUpdateRoleRequestBean createUpdateRoleRequestBean = null;
        ProjectRole response = api.comAtlassianJiraRestV2IssueProjectRoleResourceFullyUpdateProjectRolePut(id, createUpdateRoleRequestBean).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourceGetAllProjectRolesGetTest()  {
        List<ProjectRole> response = api.comAtlassianJiraRestV2IssueProjectRoleResourceGetAllProjectRolesGet().collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourceGetProjectRoleByIdGetTest()  {
        Long id = null;
        ProjectRole response = api.comAtlassianJiraRestV2IssueProjectRoleResourceGetProjectRoleByIdGet(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectRoleResourcePartialUpdateProjectRolePostTest()  {
        Long id = null;
        CreateUpdateRoleRequestBean createUpdateRoleRequestBean = null;
        ProjectRole response = api.comAtlassianJiraRestV2IssueProjectRoleResourcePartialUpdateProjectRolePost(id, createUpdateRoleRequestBean).block();
