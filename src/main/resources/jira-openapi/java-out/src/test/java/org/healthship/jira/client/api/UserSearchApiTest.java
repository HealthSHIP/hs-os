...
public class UserSearchApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindAssignableUsersGetTest()  {
        String query = null;
        ...
        List<User> response = api.comAtlassianJiraRestV2IssueUserResourceFindAssignableUsersGet(query, sessionId, username, accountId, project, issueKey, startAt, maxResults, actionDescriptorId, recommend).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindBulkAssignableUsersGetTest()  {
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.comAtlassianJiraRestV2IssueUserResourceFindBulkAssignableUsersGet(projectKeys, query, username, accountId, startAt, maxResults).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindUsersForPickerGetTest()  {
        String query = null;
        Integer maxResults = null;
        ...
        FoundUsers response = api.comAtlassianJiraRestV2IssueUserResourceFindUsersForPickerGet(query, maxResults, showAvatar, exclude, excludeAccountIds, avatarSize, excludeConnectUsers).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindUsersGetTest()  {
        String query = null;
        String username = null;
        String accountId = null;
        Integer startAt = null;
        ...
        List<User> response = api.comAtlassianJiraRestV2IssueUserResourceFindUsersGet(query, username, accountId, startAt, maxResults, property).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindUsersWithAllPermissionsGetTest()  {
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.comAtlassianJiraRestV2IssueUserResourceFindUsersWithAllPermissionsGet(permissions, query, username, accountId, issueKey, projectKey, startAt, maxResults).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueUserResourceFindUsersWithBrowsePermissionGetTest()  {
        String query = null;
        String username = null;
        String accountId = null;
        String issueKey = null;
        ...
        Integer startAt = null;
        Integer maxResults = null;
        List<User> response = api.comAtlassianJiraRestV2IssueUserResourceFindUsersWithBrowsePermissionGet(query, username, accountId, issueKey, projectKey, startAt, maxResults).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2SearchUserSearchResourceFindUserKeysByQueryGetTest()  {
        String query = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanUserKey response = api.comAtlassianJiraRestV2SearchUserSearchResourceFindUserKeysByQueryGet(query, startAt, maxResults).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2SearchUserSearchResourceFindUsersByQueryGetTest()  {
        String query = null;
        Long startAt = null;
        Integer maxResults = null;
        PageBeanUser response = api.comAtlassianJiraRestV2SearchUserSearchResourceFindUsersByQueryGet(query, startAt, maxResults).block();
