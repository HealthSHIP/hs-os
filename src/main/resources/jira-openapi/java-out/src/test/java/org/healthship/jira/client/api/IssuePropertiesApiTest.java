...
public class IssuePropertiesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssuePropertyResourceDeleteIssuePropertyDeleteTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        api.comAtlassianJiraRestV2IssueIssuePropertyResourceDeleteIssuePropertyDelete(issueIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssuePropertyResourceGetIssuePropertyGetTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        EntityProperty response = api.comAtlassianJiraRestV2IssueIssuePropertyResourceGetIssuePropertyGet(issueIdOrKey, propertyKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssuePropertyResourceGetIssuePropertyKeysGetTest()  {
        String issueIdOrKey = null;
        PropertyKeys response = api.comAtlassianJiraRestV2IssueIssuePropertyResourceGetIssuePropertyKeysGet(issueIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssuePropertyResourceSetIssuePropertyPutTest()  {
        String issueIdOrKey = null;
        String propertyKey = null;
        Object body = null;
        Object response = api.comAtlassianJiraRestV2IssueIssuePropertyResourceSetIssuePropertyPut(issueIdOrKey, propertyKey, body).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkDeleteIssuePropertyDeleteTest()  {
        String propertyKey = null;
        IssueFilterForBulkPropertyDelete issueFilterForBulkPropertyDelete = null;
        api.comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkDeleteIssuePropertyDelete(propertyKey, issueFilterForBulkPropertyDelete).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkSetIssuePropertyPutTest()  {
        String propertyKey = null;
        BulkIssuePropertyUpdateRequest bulkIssuePropertyUpdateRequest = null;
        api.comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkSetIssuePropertyPut(propertyKey, bulkIssuePropertyUpdateRequest).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkSetIssuesPropertiesPostTest()  {
        IssueEntityProperties issueEntityProperties = null;
        api.comAtlassianJiraRestV2PropertyIssuePropertyBulkUpdateResourceBulkSetIssuesPropertiesPost(issueEntityProperties).block();
