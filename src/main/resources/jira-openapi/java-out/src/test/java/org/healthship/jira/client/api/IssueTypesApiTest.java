...
public class IssueTypesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceCreateIssueTypeAvatarPostTest()  {
        String id = null;
        Integer size = null;
        Object body = null;
        Integer x = null;
        Integer y = null;
        Avatar response = api.comAtlassianJiraRestV2IssueIssueTypeResourceCreateIssueTypeAvatarPost(id, size, body, x, y).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceCreateIssueTypePostTest()  {
        IssueTypeCreateBean issueTypeCreateBean = null;
        IssueTypeDetails response = api.comAtlassianJiraRestV2IssueIssueTypeResourceCreateIssueTypePost(issueTypeCreateBean).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceDeleteIssueTypeDeleteTest()  {
        String id = null;
        String alternativeIssueTypeId = null;
        api.comAtlassianJiraRestV2IssueIssueTypeResourceDeleteIssueTypeDelete(id, alternativeIssueTypeId).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceGetAlternativeIssueTypesGetTest()  {
        String id = null;
        List<IssueTypeDetails> response = api.comAtlassianJiraRestV2IssueIssueTypeResourceGetAlternativeIssueTypesGet(id).collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceGetIssueAllTypesGetTest()  {
        List<IssueTypeDetails> response = api.comAtlassianJiraRestV2IssueIssueTypeResourceGetIssueAllTypesGet().collectList().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceGetIssueTypeGetTest()  {
        String id = null;
        IssueTypeDetails response = api.comAtlassianJiraRestV2IssueIssueTypeResourceGetIssueTypeGet(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueTypeResourceUpdateIssueTypePutTest()  {
        String id = null;
        IssueTypeUpdateBean issueTypeUpdateBean = null;
        IssueTypeDetails response = api.comAtlassianJiraRestV2IssueIssueTypeResourceUpdateIssueTypePut(id, issueTypeUpdateBean).block();
