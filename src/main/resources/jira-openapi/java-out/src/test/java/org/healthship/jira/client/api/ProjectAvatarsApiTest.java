...
public class ProjectAvatarsApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectResourceCreateProjectAvatarPostTest()  {
        String projectIdOrKey = null;
        Object body = null;
        Integer x = null;
        Integer y = null;
        Integer size = null;
        Avatar response = api.comAtlassianJiraRestV2IssueProjectResourceCreateProjectAvatarPost(projectIdOrKey, body, x, y, size).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectResourceDeleteProjectAvatarDeleteTest()  {
        String projectIdOrKey = null;
        Long id = null;
        api.comAtlassianJiraRestV2IssueProjectResourceDeleteProjectAvatarDelete(projectIdOrKey, id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectResourceGetAllProjectAvatarsGetTest()  {
        String projectIdOrKey = null;
        ProjectAvatars response = api.comAtlassianJiraRestV2IssueProjectResourceGetAllProjectAvatarsGet(projectIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueProjectResourceUpdateProjectAvatarPutTest()  {
        String projectIdOrKey = null;
        Avatar avatar = null;
        Object response = api.comAtlassianJiraRestV2IssueProjectResourceUpdateProjectAvatarPut(projectIdOrKey, avatar).block();
