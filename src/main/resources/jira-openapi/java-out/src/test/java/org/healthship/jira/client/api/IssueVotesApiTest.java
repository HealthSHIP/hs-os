...
public class IssueVotesApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceAddVotePostTest()  {
        String issueIdOrKey = null;
        Object response = api.comAtlassianJiraRestV2IssueIssueResourceAddVotePost(issueIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceGetVotesGetTest()  {
        String issueIdOrKey = null;
        Votes response = api.comAtlassianJiraRestV2IssueIssueResourceGetVotesGet(issueIdOrKey).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueResourceRemoveVoteDeleteTest()  {
        String issueIdOrKey = null;
        api.comAtlassianJiraRestV2IssueIssueResourceRemoveVoteDelete(issueIdOrKey).block();
