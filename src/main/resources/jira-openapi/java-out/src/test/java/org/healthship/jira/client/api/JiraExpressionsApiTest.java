...
public class JiraExpressionsApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2ExpressionJiraExpressionsResourceAnalyseExpressionPostTest()  {
        JiraExpressionForAnalysis jiraExpressionForAnalysis = null;
        JiraExpressionsAnalysis response = api.comAtlassianJiraRestV2ExpressionJiraExpressionsResourceAnalyseExpressionPost(jiraExpressionForAnalysis).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2ExpressionJiraExpressionsResourceEvaluateJiraExpressionPostTest()  {
        JiraExpressionEvalRequestBean jiraExpressionEvalRequestBean = null;
        String expand = null;
        JiraExpressionResult response = api.comAtlassianJiraRestV2ExpressionJiraExpressionsResourceEvaluateJiraExpressionPost(jiraExpressionEvalRequestBean, expand).block();
