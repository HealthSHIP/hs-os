...
public class IssueAttachmentsApiTest {
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueAttachmentAttachmentResourceExpandAttachmentForHumansGetTest()  {
        String id = null;
        AttachmentArchiveMetadataReadable response = api.comAtlassianJiraRestV2IssueAttachmentAttachmentResourceExpandAttachmentForHumansGet(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueAttachmentAttachmentResourceExpandAttachmentForMachinesGetTest()  {
        String id = null;
        AttachmentArchiveImpl response = api.comAtlassianJiraRestV2IssueAttachmentAttachmentResourceExpandAttachmentForMachinesGet(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueAttachmentAttachmentResourceGetAttachmentGetTest()  {
        String id = null;
        AttachmentMetadata response = api.comAtlassianJiraRestV2IssueAttachmentAttachmentResourceGetAttachmentGet(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueAttachmentAttachmentResourceGetAttachmentMetaGetTest()  {
        AttachmentSettings response = api.comAtlassianJiraRestV2IssueAttachmentAttachmentResourceGetAttachmentMetaGet().block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueAttachmentAttachmentResourceRemoveAttachmentDeleteTest()  {
        String id = null;
        api.comAtlassianJiraRestV2IssueAttachmentAttachmentResourceRemoveAttachmentDelete(id).block();
     ...
     */
    @Test
    public void comAtlassianJiraRestV2IssueIssueAttachmentsResourceAddAttachmentPostTest()  {
        String issueIdOrKey = null;
        List<Attachment> response = api.comAtlassianJiraRestV2IssueIssueAttachmentsResourceAddAttachmentPost(issueIdOrKey).collectList().block();
